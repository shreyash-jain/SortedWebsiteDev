...
const data = {
  subTitle: 'Expert App',
  title: 'Connect to clients anytime, anywhere',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'Consultations and Personal Training',
      title: 'Consultations and Personal Training',
      text: 'Best for nutritionists, counselors and therapists ',
    },
    {
      id: 2,
      imgSrc: Secure,
      altText: 'Fitness Classes',
      title: 'Workout Classes',
      text:
        'Best for Yoga, Workout, Zumba and Pilates trainer',
    },
  ],
};
...
const styles = {
  coreFeature: {
    ...
    '&::before': {
      ...
      left: 0,
      background: 'linear-gradient(-157deg, #ffedd9, #fff4e8, #fff9f2)',
      height: [350, 550, '60%'],
      width: '50%',
      zIndex: -1,
